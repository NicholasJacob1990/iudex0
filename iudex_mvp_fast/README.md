...
### Performance improvements (MVP-fast)
- Query embedding cache (TTL 1h)
- Batch embeddings for ingestion
- Qdrant multi-collection vector searches run in parallel
- Lexical-first gating for citation-heavy queries (skips vectors when lexical results are strong)
