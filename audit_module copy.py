...
(Use esta data para verificar se as referências temporais no texto são plausíveis.)
...
def auditar_consistencia_legal(client, texto_completo, output_path):
    ...
    prompt = PROMPT_AUDITORIA.format(texto=texto_completo, data_atual=data_atual)
    ...
    try:
        response = client.models.generate_content(
            ...
            config=types.GenerateContentConfig(
                ...
                thinking_config={"include_thoughts": False, "thinking_level": "HIGH"},  # v2.11: Auditoria requer raciocínio profundo
                safety_settings=[
