...
MODEL_REGISTRY: Dict[str, ModelConfig] = {
    ...
    "gpt-5.2-pro": ModelConfig(
        ...
        default=False,
        icon="openai.svg",
        api_model=os.getenv("GPT_5_2_PRO_API_MODEL", "gpt-5.2-pro"),
    ...
    "gpt-5.2-codex": ModelConfig(
        ...
        default=False,
        icon="openai.svg",
        api_model=os.getenv("GPT_5_2_CODEX_API_MODEL", "gpt-5.2-codex"),
        thinking_category="xml",
        max_output_tokens=16384,
    ),
    "gpt-5.3-codex": ModelConfig(
        ...
        default=False,
        icon="openai.svg",
        api_model=os.getenv("GPT_5_3_CODEX_API_MODEL", "gpt-5.3-codex"),
        thinking_category="xml",
        max_output_tokens=16384,
    ),
    ...
    "gpt-5.1": ModelConfig(
        ...
        default=False,
        icon="openai.svg",
        api_model=os.getenv("GPT_5_1_API_MODEL", "gpt-5.1"),
        thinking_category="xml",
        max_output_tokens=16384,
    ),
    "gpt-5.1-codex": ModelConfig(
        ...
        default=False,
        icon="openai.svg",
        api_model=os.getenv("GPT_5_1_CODEX_API_MODEL", "gpt-5.1-codex"),
        thinking_category="xml",
        max_output_tokens=16384,
    ),
    "gpt-5.1-codex-mini": ModelConfig(
        ...
        default=False,
        icon="openai.svg",
        api_model=os.getenv("GPT_5_1_CODEX_MINI_API_MODEL", "gpt-5.1-codex-mini"),
        thinking_category="agent",
    ),
    "gpt-5": ModelConfig(
        id="gpt-5",
    ...
    "gpt-5-nano": ModelConfig(
        ...
        default=False,
        icon="openai.svg",
        api_model=os.getenv("GPT_5_NANO_API_MODEL", "gpt-5-nano"),
        thinking_category="agent",
    ),
    "gpt-4o": ModelConfig(
        id="gpt-4o",
