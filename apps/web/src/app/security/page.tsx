    ...
    return (
        ...
        >
            ...
            <section className="py-24 relative snap-start bg-slate-900 dark:bg-[#050507] text-white overflow-hidden">
                <div className="container mx-auto px-6">
                    <AnimatedContainer className="text-center mb-16">
                        ...
                        <h2 className="text-3xl md:text-4xl font-bold mb-4">Certificacoes e Conformidade</h2>
                        <p className="text-xl text-gray-400 max-w-2xl mx-auto">
                            Padroes internacionais de seguranca aplicados a toda a plataforma.
                        </p>
                    </AnimatedContainer>
                    <StaggerContainer className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-5xl mx-auto">
                        {[
                            { name: "SOC 2 Type II", description: "Auditoria independente de controles de seguranca, disponibilidade e confidencialidade.", color: "from-emerald-500 to-green-600" },
                            { name: "ISO 27001", description: "Sistema de gestao de seguranca da informacao certificado internacionalmente.", color: "from-blue-500 to-cyan-600" },
                            { name: "LGPD", description: "Conformidade total com a Lei Geral de Protecao de Dados brasileira.", color: "from-amber-500 to-orange-600" },
                            { name: "GDPR", description: "Atendimento ao Regulamento Geral de Protecao de Dados europeu.", color: "from-purple-500 to-violet-600" },
                        ].map((cert, i) => (
                ...
                <AnimatedContainer className="container mx-auto px-6">
                    <div className="max-w-4xl mx-auto">
                        <div className="text-center mb-16">
                            <h2 className="text-3xl md:text-4xl font-bold mb-4 text-slate-900 dark:text-white">Protecao em cada camada</h2>
                        </div>
                        <StaggerContainer className="grid md:grid-cols-3 gap-8">
                            {[
                                { title: "Dados em transito", description: "TLS 1.3 para todas as comunicacoes. Nenhum dado trafega sem criptografia.", icon: Lock },
                                { title: "Dados em repouso", description: "AES-256 para armazenamento. Chaves gerenciadas com rotacao automatica.", icon: Key },
            ...
            <section className="py-24 relative snap-start text-center">
                <AnimatedContainer className="container mx-auto px-6">
                    <h2 className="text-3xl md:text-4xl font-bold mb-8 text-slate-900 dark:text-white">Confianca e a nossa base.</h2>
                    <Link href="/demo">
