            ...
            <section className="py-24 relative snap-start">
                <AnimatedContainer className="container mx-auto px-6">
                    <div className="text-center mb-16">
                        <h2 className="text-3xl md:text-4xl font-bold text-slate-900 dark:text-white">Resultados que importam</h2>
                    </div>
                    <StaggerContainer className="grid md:grid-cols-4 gap-8 max-w-4xl mx-auto text-center">
                        {[
                            ...
                            <MotionDiv key={i} variants={fadeUp}>
                                <div className="text-5xl font-bold text-indigo-600 dark:text-indigo-400 mb-2">{stat.value}</div>
